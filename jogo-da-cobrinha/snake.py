...
d = 20 #Dimensão do tamanho da cobrinha
...
fonte = pygame.font.SysFont("hack", 35) #Fonte

tela = pygame.display.set_mode((dimensoes))
pygame.display.set_caption('Snake Game - by Genilson Cavalcante')
...
while True:
    ...
    clock.tick(10)#Velocidade de atualização, velocidade de movimentação da cobra 